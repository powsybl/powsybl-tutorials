...
# Path to sources, for doc generation on readthedocs
...
project = 'powsybl-tutorials'
module_name = "powsybl-tutorials"
github_repository = "https://github.com/powsybl/powsybl-tutorials/"
