...
command, defining its name, its description and a theme. The theme is used to group the commands by category. Please read this documentation [page](inv:powsyblcore:std:doc#user/itools/index.html#available-commands) to discover the existing
