...
## Summary
You have learnt to create a redistribuable `iTools` package, and to configure the `itools-packager` plugin. Refer to this [iTools manual section](inv:powsyblcore:*:*#itools-available-commands) to know the list of available commands. 
